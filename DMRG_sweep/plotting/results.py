...
plt.plot(ALS_2_N, ALS_2_t, label = 'D = 2')
plt.plot(ALS_3_N, ALS_3_t, label = 'D = 3')
plt.plot(ALS_4_N, ALS_4_t, label = 'D = 4')
plt.plot(ALS_5_N, ALS_5_t, label = 'D = 5')
plt.yscale('log')
plt.xlabel('N')
...
plt.figure(figsize = (5,3))
plt.plot(ALS_2_N, ALS_2_E, label = 'D = 2')
plt.plot(ALS_3_N, ALS_3_E, label = 'D = 3')
plt.plot(ALS_4_N, ALS_4_E, label = 'D = 4')
plt.plot(ALS_5_N, ALS_5_E, label = 'D = 5')
plt.xlabel('N')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.ylabel(f'$E_0$')
plt.xlim(50, 200)
...
plt.plot(pm_2_N, pm_2_t, label = 'D = 2')
plt.plot(pm_3_N, pm_3_t, label = 'D = 3')
plt.plot(pm_4_N, pm_4_t, label = 'D = 4')
plt.plot(pm_5_N, pm_5_t, label = 'D = 5')
plt.yscale('log')
plt.xlabel('N')
plt.ylabel('t')
plt.ylim(0, 200)
...
plt.figure(figsize = (4,3))
plt.plot(pm_2_N, pm_2_E, label = 'D = 2')
plt.plot(pm_3_N, pm_3_E, label = 'D = 3')
plt.plot(pm_4_N, pm_4_E, label = 'D = 4')
plt.plot(pm_5_N, pm_5_E, label = 'D = 5')
plt.xlabel('N')
plt.ylabel(f'$E_0$')
plt.xlim(50, 200)
plt.tight_layout()
...
#scan of energies
plt.figure(figsize = (5,3))
plt.plot(ALS_3_N[1:], ALS_3_E[1:], label = 'D = 3', color = 'tab:orange')
plt.plot(ALS_4_N[1:], ALS_4_E[1:], label = 'D = 4', color = 'tab:green')
plt.plot(ALS_5_N[1:], ALS_5_E[1:], label = 'D = 5', color = 'tab:red')
plt.xlabel('N')
plt.legend(bbox_to_anchor=(1.05, 1), loc='upper left')
plt.ylabel(f'$E_0$')
plt.xlim(100, 200)
...
plt.figure(figsize = (4,3))
plt.plot(pm_3_N[1:], pm_3_E[1:], label = 'D = 3', color = 'tab:orange')
plt.plot(pm_4_N[1:], pm_4_E[1:], label = 'D = 4', color = 'tab:green')
plt.plot(pm_5_N[1:], pm_5_E[1:], label = 'D = 5', color = 'tab:red')
plt.xlabel('N')
plt.ylabel(f'$E_0$')
plt.xlim(100, 200)
plt.tight_layout()
...
plt.plot(FDM_3_N, energy_diff_3, label = 'D = 3', color = 'tab:orange')
plt.plot(FDM_4_N, energy_diff_4, label = 'D = 4', color = 'tab:green')
plt.plot(FDM_5_N, energy_diff_5, label = 'D = 5', color = 'tab:red')
plt.xlabel('N')
plt.ylabel('$|E_{0,FDM} - E_{0,ALS}|$')
plt.xlim(50, 200)
plt.legend()
plt.tight_layout()
...
# time increasement factor with D (not a plot)
